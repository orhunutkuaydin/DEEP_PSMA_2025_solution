...
class nnUNetTrainerMisalign2_LEAK(nnUNetTrainer):
    ...
    def get_training_transforms(
        ...
        # Add misalignment data augmentations from Kovacs et al. and AUTOPET 3 MIC-DKFZ LesionTracer Autopet3 submission.
        transforms.append(
            Misalign2(
                im_channels_2_misalign=(1,),
                asynchron=False,
